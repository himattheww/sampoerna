...
// toggle data ends here
  ...
  return (
    <>
    <header className=" header justify-content-md-between py-3 p-2 text-light fixed-top">
          ...
          {/* ? */}
          <div className="nav col-6 col-md-auto mt-2 justify-content-center mb-md-0" >
          <h1 className="user-roleNameNew">{user.roleName}</h1>
          </div>
          {/* ? */}
          <div >
    ...
    <div className="bg-main pb-4 pt-2" style={{marginTop: "105px"}}>
        <div className="container">
            <div className="row">
                <div className="col-12 mb-2" style={{whiteSpace: "nowrap"}}>
                <img src={profile} className="profile-image"/>
                <label className="username text-light ms-2 ">Halo, <b>{user.employeeName}</b></label>
